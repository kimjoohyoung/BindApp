...
```groovy
dependencies {
    implementation 'com.github.kimjoohyoung.BindLibrary:bindlibrary:0.954'
    kapt 'com.github.kimjoohyoung.BindLibrary:BindProcessor:0.954'
    implementation 'com.github.kimjoohyoung.BindLibrary:BindAnnotation:0.954'
